  ...
  <hr>
    ...
    <form class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <select class="form-control i-e-alta-tipo" id="inputTipopersonal" placeholder="Tipo de personal">
      ...
      <div class="userpass">
            ...
            <div class="form-group">
              <label class="col-xs-4 control-label" for="inputUsuario">Usuario</label>
              <div   class="col-xs-8"><input type="text"    class="form-control i-e-alta-nombre" id="inputUsuario" placeholder="Nombre del Usuario"></div>
            </div>

            <div class="form-group">
              <label class="col-xs-4 control-label" for="inputPassword">Password</label>
              <div   class="col-xs-8"><input type="text"    class="form-control i-e-alta-nombre" id="inputPassword" placeholder="Password del Socio"></div>
            </div>
