    ...
    <div class="row">
      <div class="col-xs-12 text-right">
        ...
        <h1 class="text-left text-uppercase text-primary">
          Transferencia <small class="text-capitalize">Productos</small>
        </h1>
...
<div id="dialog-productos-actualizar" title="Almacen - Actualizar" >
  ...
  <hr>
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group">
          <label class="col-xs-4 control-label" for="inputTipo">tipo</label>
          <div   class="col-xs-8"><span class="almacen_tipo"></span></div>
        </div>       
