      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="tipo-almacen"><a href="#" id="caja">caja</a></li>
            <li class="tipo-almacen"><a href="<?php echo site_url('ventas'); ?>">ventas</a></li>
            <li class="tipo-cajera"><a href="<?php echo site_url('almacen'); ?>">almacen</a></li>
